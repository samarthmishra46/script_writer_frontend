    ...
    <>
      ...
      <div className="bg-gradient-to-br from-[#1653F5] via-[#3CA8E3] via-[#BA63D3] via-[#FAAEA5] to-[#1449F9] p-[2px] rounded-xl shadow-lg mb-8">
        <div className="bg-white rounded-xl  ">
          ...
          <div className="flex gap-4 justify-center items-start flex-nowrap overflow-x-auto sm:flex-nowrap py-1">
            {/* Final Ad */}
            <div className="flex flex-col items-center gap-2 flex-[0_0_33.33%] max-w-[90px] sm:max-w-[180px] md:max-w-[220px]">
